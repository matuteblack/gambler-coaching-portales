...
return [
    ...
    | las reglas de tamaño. Siéntete libre de modificar estos mensajes según sea necesario.
    |
    */
    ...
    | especificar un mensaje de idioma personalizado para una regla de atributo dada.
    |
    */
